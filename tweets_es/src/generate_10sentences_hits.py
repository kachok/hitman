...
for i, lang in enumerate(langs):
	...
	parameters2=settings["tensentencesHITtype"]
	...
	cur.execute(sql,("10 sentences HIT for "+langs_properties[lang]["name"], mturk_hittype_id,  lang_id, "tensentences"))
...
for i, lang in enumerate(langs):
	...
	sql="SELECT * from tweets WHERE language_id=%s order by random();"
	...
	for batchiter in batch(rows, settings["num_unknowns"]):
		...
		for item in batchiter:
			...
			sql="INSERT INTO tensentences_hits_data (hit_id, tweet_id, language_id) VALUES (%s, %s, %s);"
...
logging.info("10 sentences hit creation pipeline - FINISH")
